...
prompt = PromptTemplate.from_template(
    """
You are a professional text analyzer. Extract this following (professor, hospital, disease) keywords by looking at the post and comments. If you cannot find the keyword, leave it blank("") and do not provide additional explanation.
{format}
