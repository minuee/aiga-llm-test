...
class Professor(BaseModel):
    ...
    professor: str = Field(description="The professor's name", required=True)
    hospital: str = Field(description="The name of the hospital affiliated with the professor", required=True)
    disease: str = Field(description="The disease or department that the professor is in charge of in the sentence")

class Professors(BaseModel):
    """Identifying information about all professors in a text."""
...
def extract_person_hospital_info(text_list):
    ...
    for text in text_list:
        try:
            result = chain.invoke({"context": text, "question":"Describe information about all professors in a text."})
            print(result)
